package com.mysql.jwt.token;

import com.mysql.jwt.db.repository.UserRepository;
import com.mysql.jwt.exception.TokenValidFailedException;
...
public class AuthTokenProvider {
    ...
    public Authentication getRealAuthentication(Claims claims, AuthToken authToken) {
        ...
        PrincipalDetails principalDetails = new PrincipalDetails(userRepository.findById(Long.parseLong(String.valueOf(claims.get("id")))).orElse(null));
